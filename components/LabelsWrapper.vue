...
<template>
  <div class="flex w-full justify-between">
    <div
      class="flex w-full space-x-2 xl:space-x-4 bg-[#edf3fd] dark:bg-[#0f172a] p-3 items-center"
    >
      <InboxIcon class="w-5 hidden sm:block dark:text-green-real" />
      <p class="text-sm dark:text-green-real">Primary</p>
    </div>
    <div class="flex w-full space-x-2 xl:space-x-4 p-3">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="w-5 hidden sm:block dark:text-green-real"
        viewBox="0 0 24 24"
      >
        <path
          fill="currentColor"
      ...
      <p class="text-sm dark:text-green-real">Promotions</p>
    </div>
    <div class="flex w-full space-x-2 xl:space-x-4 p-3">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="w-6 hidden sm:block dark:text-green-real"
        viewBox="0 0 24 24"
      >
        <g
          id="feUsers0"
      ...
      <p class="text-sm dark:text-green-real">Social</p>
    </div>
  </div>
</template>
