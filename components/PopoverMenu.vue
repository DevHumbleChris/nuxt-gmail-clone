              ...
              <div class="w-full">
                ...
                >
                  ...
                  <div class="text-left w-full">
                    <p class="dark:text-green-real">Christopher Odhiambo</p>
                    <p class="text-[9px] dark:text-green-real">
                      chrsitopherodhiambo254@gmail.com
                    </p>
                  </div>
                </div>
                <button
                  @click="logOut"
                  class="p-3 w-full rounded-xl hover:bg-[#eaf1fb] dark:hover:bg-green-real dark:hover:text-white dark:text-green-real block mt-2 sm:flex items-center space-x-4"
                >
